...
set shortmess=aoO
badd +16 www/js/controllers.js
badd +69 www/js/app.js
badd +4 www/index.html
badd +24 www/templates/home.html
badd +21 www/css/app.css
badd +1 www/js/services.js
badd +1 www/templates/pet-detail.html
badd +206 ~/.vimrc
argglobal
silent! argdel *
...
exe 'vert 1resize ' . ((&columns * 31 + 53) / 106)
exe 'vert 2resize ' . ((&columns * 74 + 53) / 106)
argglobal
enew
file NERD_tree_1
setlocal keymap=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 58 - ((30 * winheight(0) + 24) / 48)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 61 - ((27 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
61
normal! 04|
tabedit www/templates/home.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
